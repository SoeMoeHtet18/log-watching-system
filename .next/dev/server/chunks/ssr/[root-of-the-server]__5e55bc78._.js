...
;
const metadata = {
    title: "API Logs Monitor - Real-time Request Tracking",
    description: "Monitor, filter, and analyze your API requests in real-time. Track performance metrics and debug issues with advanced filtering.",
    icons: {
        icon: [
            {
                url: "/logo.png",
